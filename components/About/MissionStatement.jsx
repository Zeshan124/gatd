  ...
  return (
    <section className="bg-white py-12 sm:py-16 md:py-20">
      <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative rounded-3xl overflow-hidden border-2 border-slate-200" style={{ minHeight: "420px" }}>
          ...
          {/* White Content Panel — overlaid on RIGHT side */}
          <div className="relative z-10 w-full lg:w-1/2 bg-white m-4 sm:m-6 md:m-8 rounded-2xl px-7 sm:px-9 md:px-10 py-9 sm:py-11 md:py-12 flex flex-col justify-center shadow-sm ml-auto">
